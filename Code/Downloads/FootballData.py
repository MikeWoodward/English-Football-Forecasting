...
football-data.co.uk. It supports downloading data for multiple English football
leagues including Premier League (E0), Championship (E1), League One (E2), League
Two (E3), and Conference (EC).
    ...
    for year in range(1993, 2024):
        for league in ['E0', 'E1', 'E2', 'E3', 'EC']:
            ...
            if 'Time' in data_df.columns:
                ...
                # If no time column exists, set a default time
                data_df['match_time'] = ''
