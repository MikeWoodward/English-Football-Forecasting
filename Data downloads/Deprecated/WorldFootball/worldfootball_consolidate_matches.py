...
def read_attendance4s(
    directory: str = "../../RawData/Matches/WorldFootball_Attendance"
) -> List[pd.DataFrame]:
...
def combine_attendance4s(dfs: List[pd.DataFrame]) -> pd.DataFrame:
    ...
    attendance4 = attendance4.sort_values(
...
def main() -> None:
    ...
    try:
        ...
        output_path = Path("../../RawData/Matches/WorldFootball_Attendance/worldfootball_attendance.csv")
