...
urlpatterns = [
    ...
    path('home-advantage-over-time/', views.home_advantage_over_time, name='home_advantage_over_time'),
    path('draw-fraction-over-time/', views.draw_fraction_over_time, name='draw_fraction_over_time'),
    path(
